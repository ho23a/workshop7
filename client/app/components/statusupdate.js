      ...
      <div>
          ...
          <div className="col-md-2">
            <div className={"dropdown"}>
              ...
              <ul className="dropdown-menu">
                <li className={hideElement(this.props.author._id !== "000000000000000000000004")}>
                  <a onClick={(e) => this.onEditClick(e)}>Edit Status Update</a>
                </li>
                <li className={hideElement(this.props.author._id !== "000000000000000000000004")}>
                  <a onClick={(e) => this.onDelete(e)}>Delete Status Update</a>
                </li>
        ...
        <div className="row">
          <div className="col-md-12">
            {
              /*
                  this.props.image is a data URI, so we can plug it in as the source
                  of an image and it will display!
               */
            }
            <img className={hideElement(typeof(this.props.image) !== "string")} style={{width: "100%"}} src={this.props.image} />
          </div>
        </div>
      </div>
    )
